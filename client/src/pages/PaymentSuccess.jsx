        ...
        <main className="px-10 py-2 min-h-screen">
            ...
            <section className="border-t-4 w-1/2 mx-auto border-secondary">
                ...
                <div className="py-4 text-center flex flex-col gap-2">
                    ...
                    <p className="">
                        We have received Tk <strong>{paymentDetails?.total_amount}</strong> for the Event <strong> {paymentDetails?.product_name} </strong> on <strong> {paymentDetails?.event_date}</strong>. Wishing you All the Best. <br />
                        Cheers!
                    </p>
                </div>
